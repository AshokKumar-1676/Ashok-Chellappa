  ...
  return (
    <div className="flex flex-col min-h-full bg-plum-bg">
      ...
      <div className="flex-1 px-6 pb-24">
         {/* Product Highlight */}
         <div className="bg-white rounded-3xl p-6 shadow-xl mb-6 flex flex-col items-center text-center relative overflow-hidden">
            <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-green-400 to-teal-500"></div>
            <div className="w-24 h-24 bg-green-50 rounded-full flex items-center justify-center text-green-600 mb-4 animate-pulse-slow">
                <Leaf size={40} />
            </div>
         ...
         {/* Subscribe Option */}
         <div className="bg-plum-primary/5 rounded-2xl p-4 border border-plum-primary/20 flex items-center justify-between">
            <div>
      ...
      <div className="fixed bottom-0 left-0 right-0 p-4 bg-white border-t border-gray-100 z-50 flex justify-center">
        <div className="w-full max-w-[430px] flex gap-4">
             <button className="flex-1 bg-white border border-plum-primary text-plum-primary font-bold py-3 rounded-xl hover:bg-plum-light transition-colors">
                 Add to Cart
             </button>
             <button className="flex-1 bg-plum-primary text-white font-bold py-3 rounded-xl shadow-lg hover:bg-plum-deep transition-colors flex items-center justify-center gap-2">
